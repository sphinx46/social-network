...
public class KafkaConsumerConfig {
    ...
    private <T> Map<String, Object> consumerConfig(Class<T> clazz) {
        ...
        config.put(ConsumerConfig.GROUP_ID_CONFIG, "user-profile-service-group");
    ...
    /**
     * Создает KafkaListenerContainerFactory для обработки событий загрузки аватаров.
     ...
     *
     * @return настроенный KafkaListenerContainerFactory для работы с AvatarUploadedEvent
     */
    @Bean
    public KafkaListenerContainerFactory
            <ConcurrentMessageListenerContainer<String, AvatarUploadedEvent>>
    kafkaListenerContainerFactoryAvatarUpload() {
        log.info("KAFKA_AVATAR_LISTENER_FACTORY_СОЗДАНИЕ: инициализация фабрики для AvatarUploadedEvent");
        return createFactory(AvatarUploadedEvent.class);
    }
}