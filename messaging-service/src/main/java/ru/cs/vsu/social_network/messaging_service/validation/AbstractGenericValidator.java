...
import ru.cs.vsu.social_network.messaging_service.provider.EntityProvider;
 ...
 */
@Slf4j
public abstract class AbstractGenericValidator<T> implements GenericValidator<T> {

    protected final EntityProvider<T> entityProvider;
    protected final String entityName;

    protected AbstractGenericValidator(EntityProvider<T> entityProvider,
                                       String entityName) {
