...
/**
 * Конфигурация кеширования для сервиса сообщений.
...
public class CacheConfig {
    ...
    public CacheManager cacheManager(
        ...
        Jackson2JsonRedisSerializer<PageResponse<ConversationResponse>>
                conversationPageSerializer =
                new Jackson2JsonRedisSerializer<>(
                        createObjectMapperForRedis(objectMapper),
                        objectMapper.getTypeFactory()
                                .constructParametricType(PageResponse.class, ConversationResponse.class)
                );

        RedisCacheConfiguration conversationCacheConfig =
        ...
        RedisCacheConfiguration conversationPageCacheConfig =
                RedisCacheConfiguration.defaultCacheConfig()
                ...
                .serializeKeysWith(RedisSerializationContext.SerializationPair
                        .fromSerializer(new StringRedisSerializer()))
                .serializeValuesWith(RedisSerializationContext.SerializationPair
                        .fromSerializer(conversationPageSerializer))
                .prefixCacheNameWith("");

        return RedisCacheManager.builder(connectionFactory)
                .withCacheConfiguration("conversation", conversationCacheConfig)
                .withCacheConfiguration("conversationPage", conversationPageCacheConfig)
                .transactionAware()
                .build();
    }
