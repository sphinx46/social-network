...
public class KafkaConsumerConfig {
    ...
    private <T> Map<String, Object> consumerConfig(Class<T> clazz) {
        ...
        config.put(ConsumerConfig.GROUP_ID_CONFIG, "content-service-group");
    ...
    /**
     * Создает KafkaListenerContainerFactory для обработки событий загрузки изображений постов.
     ...
     *
     * @return настроенный KafkaListenerContainerFactory для работы с PostImageUploadedEvent
     */
    @Bean
