...
public class PostDetailsServiceImpl implements PostDetailsService {
    ...
    @Cacheable(
            value = "postDetails",
            key = "'post:' + #postId + ':comments:' + #includeComments + ':likes:' + #includeLikes + ':commentsLimit:' + #commentsLimit + ':likesLimit:' + #likesLimit",
            unless = "#result == null"
    )
    ...
    @Transactional(readOnly = true)
    @Cacheable(
            value = "userPageDetails",
            key = "'user:' + #userId + ':page:' + #pageRequest.pageNumber + ':size:' + #pageRequest.size + ':sort:' + #pageRequest.sortBy + ':dir:' + #pageRequest.direction + ':comments:' + #includeComments + ':likes:' + #includeLikes + ':commentsLimit:' + #commentsLimit + ':likesLimit:' + #likesLimit",
    ...
    @Transactional(readOnly = true)
    @Cacheable(
            value = "allPageDetails",
            key = "'all:page:' + #pageRequest.pageNumber + ':size:' + #pageRequest.size + ':sort:' + #pageRequest.sortBy + ':dir:' + #pageRequest.direction + ':comments:' + #includeComments + ':likes:' + #includeLikes + ':commentsLimit:' + #commentsLimit + ':likesLimit:' + #likesLimit",
            unless = "#result == null or #result.content.isEmpty()"
    )
